...
type Event struct {
	...
	Type           string         `gorm:"not null" json:"type"` // location_update, status_change, scan, delivery, pickup, customs_clearance
	...
	Source         string         `json:"source"` // gps, manual, scanner, api, iot
...
type Alert struct {
	ID             uuid.UUID      `gorm:"type:uuid;primary_key" json:"id"`
	Type           string         `gorm:"not null" json:"type"` // delay, temperature_breach, geofence_exit, maintenance_required, low_battery
	Severity       string         `json:"severity"` // low, medium, high, critical
	Title          string         `gorm:"not null" json:"title"`
	Message        string         `json:"message"`
	Status         string         `json:"status" gorm:"default:'active'"` // active, acknowledged, resolved, ignored
